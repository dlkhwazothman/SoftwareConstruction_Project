		...
		<form method="post" action="model/customer.jsp">
          ...
          <div id="password_row">
			  <div class="half_width">
				...
				<input type="password" name="customer_password" id="customer_password" value="test" size="22" style="width:300px;" required>
			  </div>
			  <div class="half_width">
				<label for="email">Confirm Password<span>*</span></label>
				<input type="password" name="customer_confirm_password" id="customer_confirm_password" value="test" size="22" style="width:300px;" required>
			  </div>
		  </div>
          <div class="half_width">

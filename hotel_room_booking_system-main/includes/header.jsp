  ...
  <div id="topbar" class="clear"> 
    <nav>
      <ul>
        ...
        <li><a href="customer-login.jsp">Cutomer Login</a></li>
...
<div class="wrapper row1">
  <header id="header" class="clear"> 
    <div id="logo" class="fl_left">
      ...
      <p style="color:#ffffff">A complete solution to manage hotel rooms and facilities</p>
      </div>
    </div>
    <div class="fl_right">
      ...
      <ul class="clear">
		...
		<li><a href="#" class="drop" >Reports</a>
         <ul>
			...
			<li><a href="report-booking.jsp">Booking Reports</a></li>
          </ul>
        </li>
